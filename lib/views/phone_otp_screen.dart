...
import 'package:the_staff_hound/controllers/opt_controller.dart';
import 'package:the_staff_hound/custom_widgets/app_button.dart';
import 'package:the_staff_hound/custom_widgets/app_text.dart';

class PhoneOTPActivity extends StatelessWidget {
  final controller = Get.put(OTPController());
  PhoneOTPActivity({Key? key}) : super(key: key);
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: AppText(
                        text:
                            "Enter the OTP code just sent to your phone number",
                        isBold: true,
                        textSize: 15,
                      ),
                    ),
                    ...
                    InkWell(
                      onTap: () {
                        /* if(controller.status.value == 'forgotPassword'){
                        Get.off(() => const ResetPasswordActivity());
                        }else{
