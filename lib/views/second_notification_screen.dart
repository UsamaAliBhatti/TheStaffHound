...
import '../controllers/second_notification_controller.dart';
import '../custom_widgets/app_text.dart';

class SecondNotificationScreen extends StatelessWidget {
  final controller = Get.put(SecondNotificationController());
  @override
  SecondNotificationScreen({Key? key}) : super(key: key);
          ...
          return Column(
              ...
              children: [
                Container(
                  ...
                  child: AppText(
                    text: 'Congratulation! You have been approved for this job',
                ...
                /* controller.isAccepted.value == 'accepted'
                    ? Container(
                        ...
                        height: 60,
                        child: AppText(
                          text: controller.isAccepted.value,
                          textSize: 20,
                          isBold: true,
                          textColor: Colors.white,
                        ),
              ...
              Row(
                ...
                children: [
                  ...
                  AnimateIcons(
                      ...
                      endIcon: Icons.keyboard_arrow_down_sharp,
                      onStartIconPress: () {
                        // jobDetailController.isDescriptionPressed.value = true;
                        return true;
                      },
                      onEndIconPress: () {
                        // jobDetailController.isDescriptionPressed.value = false;
                        return true;
                      },
                      duration: const Duration(milliseconds: 500),
                      controller: AnimateIconController()),
              ...
              Row(
                ...
                children: [
                  ...
                  AnimateIcons(
                      ...
                      endIcon: Icons.keyboard_arrow_down_sharp,
                      onStartIconPress: () {
                        // jobDetailController.isDutiesPressed.value = true;
                        return true;
                      },
                      onEndIconPress: () {
                        // jobDetailController.isDutiesPressed.value = false;
                        return true;
                      },
                      duration: const Duration(milliseconds: 500),
                      controller: AnimateIconController()),
